...
public class InviteEvent extends SipEvent {
  ...
  protected InviteEvent(long cPtr, boolean cMemoryOwn) {
    super(baseWRAPJNI.InviteEvent_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_InviteEvent(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public tsip_invite_event_type_t getType() {
    return tsip_invite_event_type_t.swigToEnum(baseWRAPJNI.InviteEvent_getType(swigCPtr, this));
  }

  public twrap_media_type_t getMediaType() {
    return twrap_media_type_t.swigToEnum(baseWRAPJNI.InviteEvent_getMediaType(swigCPtr, this));
  }

  public InviteSession getSession() {
    long cPtr = baseWRAPJNI.InviteEvent_getSession(swigCPtr, this);
    return (cPtr == 0) ? null : new InviteSession(cPtr, false);
  }

  public CallSession takeCallSessionOwnership() {
    long cPtr = baseWRAPJNI.InviteEvent_takeCallSessionOwnership(swigCPtr, this);
    return (cPtr == 0) ? null : new CallSession(cPtr, true);
  }

  public MsrpSession takeMsrpSessionOwnership() {
    long cPtr = baseWRAPJNI.InviteEvent_takeMsrpSessionOwnership(swigCPtr, this);
