...
public class MessagingEvent extends SipEvent {
  ...
  protected MessagingEvent(long cPtr, boolean cMemoryOwn) {
    super(baseWRAPJNI.MessagingEvent_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_MessagingEvent(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public tsip_message_event_type_t getType() {
    return tsip_message_event_type_t.swigToEnum(baseWRAPJNI.MessagingEvent_getType(swigCPtr, this));
  }

  public MessagingSession getSession() {
    long cPtr = baseWRAPJNI.MessagingEvent_getSession(swigCPtr, this);
    return (cPtr == 0) ? null : new MessagingSession(cPtr, false);
  }

  public MessagingSession takeSessionOwnership() {
    long cPtr = baseWRAPJNI.MessagingEvent_takeSessionOwnership(swigCPtr, this);
