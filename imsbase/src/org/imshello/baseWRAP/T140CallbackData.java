...
public class T140CallbackData {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_T140CallbackData(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public tmedia_t140_data_type_t getType() {
    return tmedia_t140_data_type_t.swigToEnum(baseWRAPJNI.T140CallbackData_getType(swigCPtr, this));
  }

  public long getSize() {
    return baseWRAPJNI.T140CallbackData_getSize(swigCPtr, this);
  }

  public long getData(java.nio.ByteBuffer pOutput, long nMaxsize) {
    return baseWRAPJNI.T140CallbackData_getData(swigCPtr, this, pOutput, nMaxsize);
  }
