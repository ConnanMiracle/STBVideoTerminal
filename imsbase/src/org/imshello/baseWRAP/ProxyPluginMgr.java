...
public class ProxyPluginMgr {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_ProxyPluginMgr(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
