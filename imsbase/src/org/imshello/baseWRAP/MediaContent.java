...
public class MediaContent {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_MediaContent(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public String getType() {
    return baseWRAPJNI.MediaContent_getType(swigCPtr, this);
  }

  public long getDataLength() {
    return baseWRAPJNI.MediaContent_getDataLength(swigCPtr, this);
  }

  public long getData(java.nio.ByteBuffer pOutput, long nMaxsize) {
    return baseWRAPJNI.MediaContent_getData(swigCPtr, this, pOutput, nMaxsize);
  }

  public static MediaContent parse(java.nio.ByteBuffer pData, long nSize, String pType) {
    long cPtr = baseWRAPJNI.MediaContent_parse__SWIG_0(pData, nSize, pType);
    return (cPtr == 0) ? null : new MediaContent(cPtr, true);
  }

  public static MediaContentCPIM parse(java.nio.ByteBuffer pData, long nSize) {
    long cPtr = baseWRAPJNI.MediaContent_parse__SWIG_1(pData, nSize);
    return (cPtr == 0) ? null : new MediaContentCPIM(cPtr, true);
  }

  public long getPayloadLength() {
    return baseWRAPJNI.MediaContent_getPayloadLength(swigCPtr, this);
  }

  public long getPayload(java.nio.ByteBuffer pOutput, long nMaxsize) {
    return baseWRAPJNI.MediaContent_getPayload(swigCPtr, this, pOutput, nMaxsize);
  }
