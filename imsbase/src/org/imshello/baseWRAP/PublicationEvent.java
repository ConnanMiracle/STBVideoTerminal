...
public class PublicationEvent extends SipEvent {
  ...
  protected PublicationEvent(long cPtr, boolean cMemoryOwn) {
    super(baseWRAPJNI.PublicationEvent_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_PublicationEvent(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public tsip_publish_event_type_t getType() {
    return tsip_publish_event_type_t.swigToEnum(baseWRAPJNI.PublicationEvent_getType(swigCPtr, this));
  }

  public PublicationSession getSession() {
    long cPtr = baseWRAPJNI.PublicationEvent_getSession(swigCPtr, this);
    return (cPtr == 0) ? null : new PublicationSession(cPtr, false);
  }

  public PublicationSession takeSessionOwnership() {
    long cPtr = baseWRAPJNI.PublicationEvent_takeSessionOwnership(swigCPtr, this);
    return (cPtr == 0) ? null : new PublicationSession(cPtr, false);
  }
