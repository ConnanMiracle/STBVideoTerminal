...
public class SubscriptionEvent extends SipEvent {
  ...
  protected SubscriptionEvent(long cPtr, boolean cMemoryOwn) {
    super(baseWRAPJNI.SubscriptionEvent_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_SubscriptionEvent(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public tsip_subscribe_event_type_t getType() {
    return tsip_subscribe_event_type_t.swigToEnum(baseWRAPJNI.SubscriptionEvent_getType(swigCPtr, this));
  }

  public SubscriptionSession getSession() {
    long cPtr = baseWRAPJNI.SubscriptionEvent_getSession(swigCPtr, this);
    return (cPtr == 0) ? null : new SubscriptionSession(cPtr, false);
  }

  public SubscriptionSession takeSessionOwnership() {
    long cPtr = baseWRAPJNI.SubscriptionEvent_takeSessionOwnership(swigCPtr, this);
    return (cPtr == 0) ? null : new SubscriptionSession(cPtr, false);
  }
