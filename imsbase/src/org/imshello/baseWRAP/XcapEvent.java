...
public class XcapEvent {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        baseWRAPJNI.delete_XcapEvent(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public thttp_event_type_t getType() {
    return thttp_event_type_t.swigToEnum(baseWRAPJNI.XcapEvent_getType(swigCPtr, this));
  }

  public XcapMessage getXcapMessage() {
    long cPtr = baseWRAPJNI.XcapEvent_getXcapMessage(swigCPtr, this);
