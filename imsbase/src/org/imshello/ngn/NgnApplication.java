...
import org.imshello.utils.CpuFeatures_t;
 ...
 * The Stack is based on <a href="http://imshello.org">imshello</a> framework. <a href="http://imshello.org">imshello</a> is the world's most advanced open source 
 ...
 * 
 * @page Introduction
 * This document has been written by us (imshello Telecom) to help developers to quickly create innovative multimedia applications
 ...
 * 
 * <h2>imshello Solution</h2>
 * <b>android-ngn-stack</b> is part of imshello Solution which include many components such as:
 * 
 ...
 * 		- Package name: <b>org.imshello.test</b><br />
 ...
 * <h2>Low level</h2>
 * This level allow you to directly have access to imshello functions through JNI.
 * This level is the most flexible one but is out of scoop because it's too difficult to manage. <br />
 * All functions used in this level are in one single package: <b>org.imshello.baseWRAP</b><br />
 * For example, the code below shows how to register to a SIP/IMS server:
 * @code
 * final String realm = "sip:imshello.org";
 * final String privateIdentity = "001";
 * final String publicIdentity = "sip:001@imshello.org";
