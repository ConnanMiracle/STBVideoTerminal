...
import org.imshello.ngn.media.NgnProxyAudioConsumer;
import org.imshello.ngn.media.NgnProxyAudioProducer;
import org.imshello.ngn.media.NgnProxyPlugin;
import org.imshello.ngn.media.NgnProxyPluginMgr;
import org.imshello.ngn.media.NgnProxyVideoConsumer;
import org.imshello.ngn.media.NgnProxyVideoProducer;
import org.imshello.ngn.model.NgnHistoryAVCallEvent;
...
import org.imshello.ngn.utils.NgnListUtils;
...
import org.imshello.baseWRAP.Codec;
...
import org.imshello.baseWRAP.T140Callback;
import org.imshello.baseWRAP.T140CallbackData;
...
import org.imshello.baseWRAP.tmedia_t140_data_type_t;
...
public class NgnAVSession extends NgnInviteSession{
    ...
    protected NgnAVSession(NgnSipStack sipStack, CallSession session, NgnMediaType mediaType, InviteState callState){
	    ...
	    //added by wangy 20140714
	    //AnswerPhoneBroadcastReceiver receiver=new AnswerPhoneBroadcastReceiver();
	    //NgnApplication.getInstance().getApplicationContext().registerReceiver(receiver, new IntentFilter("org.imshello.ANSWERPHONE_ON"));
	...
	public void pushBlankPacket(){
		...
		//added by wangy for sending blank packet to open NAT
		if(mAudioProducer != null){
			mAudioProducer.pushBlankPacket();
		}
