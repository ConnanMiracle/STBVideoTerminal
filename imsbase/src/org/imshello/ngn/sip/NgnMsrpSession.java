...
import org.imshello.ngn.events.NgnMsrpEventArgs;
import org.imshello.ngn.events.NgnMsrpEventTypes;
import org.imshello.ngn.media.NgnMediaType;
import org.imshello.ngn.model.NgnHistoryEvent;
import org.imshello.ngn.model.NgnHistoryMsrpEvent;
...
import org.imshello.baseWRAP.MediaContent;
import org.imshello.baseWRAP.MediaContentCPIM;
import org.imshello.baseWRAP.MsrpCallback;
import org.imshello.baseWRAP.MsrpEvent;
import org.imshello.baseWRAP.MsrpMessage;
import org.imshello.baseWRAP.MsrpSession;
import org.imshello.baseWRAP.SdpMessage;
import org.imshello.baseWRAP.SipMessage;
import org.imshello.baseWRAP.SipSession;
import org.imshello.baseWRAP.tmsrp_event_type_t;
import org.imshello.baseWRAP.tmsrp_request_type_t;
...
public class NgnMsrpSession extends NgnInviteSession {
	...
	public boolean sendFile(String path) {
		...
		config.setMediaString(twrap_media_type_t.twrap_media_msrp, "file-path",mFilePath)
			...
			.setMediaString(twrap_media_type_t.twrap_media_msrp, "file-icon","cid:test@imshello.org")
