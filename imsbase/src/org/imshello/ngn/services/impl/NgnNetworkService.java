...
public class NgnNetworkService  extends NgnBaseService implements INgnNetworkService {
	...
	public boolean start() {
		...
		if(!isBroadcastReceiverRegistered){
			...
			engine.getMainActivity().registerReceiver(receiver, filter);
	...
	public boolean stop() {
		...
		if(isBroadcastReceiverRegistered){			
			engine.getMainActivity().unregisterReceiver(receiver);
	...
	public boolean acquire() {
		...
		Log.e(NgnNetworkService.TAG, netType+" "+netSubType);
		...
		boolean useEthernet = NgnEngine.getInstance().getConfigurationService().getBoolean(NgnConfigurationEntry.NETWORK_USE_ETHERNET,
				NgnConfigurationEntry.DEFAULT_NETWORK_USE_ETHERNET);
		...
		if (useEthernet) {
			Log.e(NgnNetworkService.TAG, "use ethernet");
			connected = true;
		}
...
//			}
	...
	public void triggerSipRegistration(){
		...
		receiver = new BroadcastReceiver() {
			...
			public void onReceive(Context arg0, Intent arg1) {
				...
				if (arg1.getAction().equals(
					...
					ConnectivityManager connectivityManager = (ConnectivityManager)(engine.getMainActivity().
