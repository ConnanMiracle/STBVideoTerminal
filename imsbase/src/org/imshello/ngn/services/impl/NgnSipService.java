...
import org.imshello.ngn.events.NgnMessagingEventArgs;
import org.imshello.ngn.events.NgnMessagingEventTypes;
import org.imshello.ngn.events.NgnPublicationEventArgs;
import org.imshello.ngn.events.NgnPublicationEventTypes;
import org.imshello.ngn.events.NgnRegistrationEventArgs;
import org.imshello.ngn.events.NgnRegistrationEventTypes;
import org.imshello.ngn.events.NgnSubscriptionEventArgs;
import org.imshello.ngn.events.NgnSubscriptionEventTypes;
import org.imshello.ngn.model.NgnDeviceInfo.Orientation;
...
import org.imshello.ngn.sip.NgnInviteSession;
...
import org.imshello.ngn.sip.NgnPublicationSession;
import org.imshello.ngn.sip.NgnRegistrationSession;
import org.imshello.ngn.sip.NgnSipPrefrences;
import org.imshello.ngn.sip.NgnSipSession;
import org.imshello.ngn.sip.NgnSipStack;
import org.imshello.ngn.sip.NgnSubscriptionSession;
import org.imshello.ngn.sip.NgnInviteSession.InviteState;
import org.imshello.ngn.sip.NgnSipSession.ConnectionState;
import org.imshello.ngn.sip.NgnSipStack.STACK_STATE;
import org.imshello.ngn.sip.NgnSubscriptionSession.EventPackageType;
import org.imshello.ngn.utils.NgnConfigurationEntry;
import org.imshello.ngn.utils.NgnContentType;
import org.imshello.ngn.utils.NgnDateTimeUtils;
import org.imshello.ngn.utils.NgnStringUtils;
import org.imshello.ngn.utils.NgnUriUtils;
import org.imshello.baseWRAP.CallSession;
import org.imshello.baseWRAP.DDebugCallback;
import org.imshello.baseWRAP.DialogEvent;
import org.imshello.baseWRAP.InviteEvent;
import org.imshello.baseWRAP.InviteSession;
import org.imshello.baseWRAP.MessagingEvent;
import org.imshello.baseWRAP.MessagingSession;
import org.imshello.baseWRAP.MsrpSession;
import org.imshello.baseWRAP.OptionsEvent;
import org.imshello.baseWRAP.OptionsSession;
import org.imshello.baseWRAP.RPMessage;
import org.imshello.baseWRAP.SMSData;
import org.imshello.baseWRAP.SMSEncoder;
import org.imshello.baseWRAP.SipCallback;
import org.imshello.baseWRAP.SipMessage;
import org.imshello.baseWRAP.SipSession;
import org.imshello.baseWRAP.SipStack;
import org.imshello.baseWRAP.StackEvent;
import org.imshello.baseWRAP.SubscriptionEvent;
import org.imshello.baseWRAP.SubscriptionSession;
import org.imshello.baseWRAP.baseWRAPConstants;
import org.imshello.baseWRAP.tsip_event_type_t;
import org.imshello.baseWRAP.tsip_invite_event_type_t;
import org.imshello.baseWRAP.tsip_message_event_type_t;
import org.imshello.baseWRAP.tsip_options_event_type_t;
import org.imshello.baseWRAP.tsip_request_type_t;
import org.imshello.baseWRAP.tsip_subscribe_event_type_t;
import org.imshello.baseWRAP.twrap_media_type_t;
import org.imshello.baseWRAP.twrap_sms_type_t;
...
public class NgnSipService extends NgnBaseService implements INgnSipService,
	...
	public boolean register(Context context) {
		...
		// let imshello retrieve the best IP address)
		boolean ipv6 = NgnStringUtils.equals(mPreferences.getIPVersion(),
				"ipv6", true);
		Log.e(TAG, mNetworkService.getLocalIP(ipv6));
	...
	static class MySipCallback extends SipCallback {
		...
		public int OnDialogEvent(DialogEvent e) {
			...
			switch (eventCode) {
			// == Connecting ==
			case baseWRAPConstants.tsip_event_code_dialog_connecting: {
				// Registration
			...
			// == Connected == //
			case baseWRAPConstants.tsip_event_code_dialog_connected: {
				// Registration
				if (mSipService.mRegSession != null
						&& mSipService.mRegSession.getId() == sessionId) {
					mSipService.mRegSession
			...
			// == Terminating == //
			case baseWRAPConstants.tsip_event_code_dialog_terminating: {
				// Registration
				if (mSipService.mRegSession != null
						&& mSipService.mRegSession.getId() == sessionId) {
					mSipService.mRegSession
			...
			// == Terminated == //
			case baseWRAPConstants.tsip_event_code_dialog_terminated: {
				// Registration
				if (mSipService.mRegSession != null
						&& mSipService.mRegSession.getId() == sessionId) {
					mSipService.mRegSession
                ...
                case tsip_i_request:
                    {
                    	...
                    	if(sipMessage != null && session != null && ((mySession = NgnAVSession.getSession(session.getId())) != null)){
                    		if(sipMessage.getRequestType() == tsip_request_type_t.tsip_INFO){
                    			...
                    			if(NgnStringUtils.equals(contentType, NgnContentType.imshello_DEVICE_INFO, true)){
		...
		public int OnStackEvent(StackEvent e) {
			...
			final short code = e.getCode();
			switch (code) {
			case baseWRAPConstants.tsip_event_code_stack_started:
				mSipService.mSipStack.setState(STACK_STATE.STARTED);
				Log.d(NgnSipService.TAG, "Stack started");
				break;
			case baseWRAPConstants.tsip_event_code_stack_failed_to_start:
				final String phrase = e.getPhrase();
				Log.e(TAG, String.format(
						"Failed to start the stack. \nAdditional info:\n%s",
						phrase));
				break;
			case baseWRAPConstants.tsip_event_code_stack_failed_to_stop:
				Log.e(TAG, "Failed to stop the stack");
				break;
			case baseWRAPConstants.tsip_event_code_stack_stopped:
				mSipService.mSipStack.setState(STACK_STATE.STOPPED);
				Log.d(TAG, "Stack stopped");
				break;
			case baseWRAPConstants.tsip_event_code_stack_disconnected:
