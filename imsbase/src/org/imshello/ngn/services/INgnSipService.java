 ...
 * final String validUri = NgnUriUtils.makeValidSipUri(remoteUri); // sip:+33600000000"@imshello.org
 ...
 * @code
 * final String SMSC = "sip:+3310000000@imshello.org"; // SMS Center
 * final String remotePartyUri = "sip:+336000000@imshello.org"; // remote party
 ...
 * @code 
 * final String myRealm = "sip:imshello.org"; 
 ...
 * @code
 * final boolean bSaveNow = true; 
 * final String myIMPU = "sip:33446677887@imshello.org"; 
 ...
 * The Proxy-CSCF Host is the IP address (192.168.0.1) or FQDN (imshello.org) of the SIP registrar. <br />
