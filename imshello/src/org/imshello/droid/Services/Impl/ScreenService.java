...
*/
package org.imshello.droid.Services.Impl;
...
import org.imshello.droid.Screens.IBaseScreen;
...
import org.imshello.ngn.services.impl.NgnBaseService;
...
public class ScreenService extends NgnBaseService implements IScreenService {
	...
	public boolean show(String id) {
		final  Activity screen = ((Main)Engine.getInstance().getMainActivity()).getLocalActivityManager().getActivity(id);
		if (screen == null) {
