...
public class SettingsQoS  extends BaseScreen {
	...
	private EditText screen_qos_editText_vfps;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.settings_qos);
        ...
        screen_qos_editText_vfps=(EditText)findViewById(R.id.screen_qos_editText_vfps);
        // spinners
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, SettingsQoS.sSpinnerRefresherItems);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpRefresher.setAdapter(adapter);
        
        ArrayAdapter<ScreenQoSStrength> adapterStrength = new ArrayAdapter<ScreenQoSStrength>(this, android.R.layout.simple_spinner_item, SettingsQoS.sSpinnerPrecondStrengthItems);
        ...
        ArrayAdapter<ScreenQoSType> adapterType = new ArrayAdapter<ScreenQoSType>(this, android.R.layout.simple_spinner_item, SettingsQoS.sSpinnerPrecondTypeItems);
        adapterType.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpPrecondType.setAdapter(adapterType);
        
        ArrayAdapter<ScreenQoSVsize> adapterVsize = new ArrayAdapter<ScreenQoSVsize>(this, android.R.layout.simple_spinner_item, SettingsQoS.sSpinnerVsizeItems);
		...
		screen_qos_editText_vfps.setText(String.valueOf(mConfigurationService.getInt(NgnConfigurationEntry.QOS_VIDEO_FPS,
		...
		addConfigurationListener(screen_qos_editText_vfps);
	...
	protected void onPause() {
		if(super.mComputeConfiguration){
			...
			mConfigurationService.putInt(NgnConfigurationEntry.QOS_VIDEO_FPS, 
					NgnStringUtils.parseInt(screen_qos_editText_vfps.getText().toString().trim(), NgnConfigurationEntry.DEFAULT_QOS_VIDEO_FPS));
		...
		Toast.makeText(this, sSpinnerVsizeItems[mSpVsize.getSelectedItemPosition()].mValue.toString()+"\n"+
				mConfigurationService.getString(
						NgnConfigurationEntry.QOS_PREF_VIDEO_SIZE,
						NgnConfigurationEntry.DEFAULT_QOS_PREF_VIDEO_SIZE)+"\n"+
						tmedia_pref_video_size_t.valueOf(mConfigurationService.getString(
								NgnConfigurationEntry.QOS_PREF_VIDEO_SIZE,
								NgnConfigurationEntry.DEFAULT_QOS_PREF_VIDEO_SIZE)), Toast.LENGTH_SHORT).show();
		super.onPause();
	}	
