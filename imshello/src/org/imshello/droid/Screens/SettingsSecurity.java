...
public class SettingsSecurity extends BaseScreen {
	private final static String TAG = SettingsSecurity.class.getCanonicalName();
	...
	protected void onCreate(Bundle savedInstanceState) {
      ...
      // get controls
        ...
        ArrayAdapter<ScreenSecuritySRtpMode> adapterSrtpMode = new ArrayAdapter<ScreenSecuritySRtpMode>(this, android.R.layout.simple_spinner_item, SettingsSecurity.sSpinnerSRtpModeItems);
        ...
        ArrayAdapter<ScreenSecuritySRtpType> adapterType = new ArrayAdapter<ScreenSecuritySRtpType>(this, android.R.layout.simple_spinner_item, SettingsSecurity.sSpinnerSRtpTypeItems);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == SettingsSecurity.REQUEST_CODE_PRIV_KEY) {
			Uri uri = data.getData();
			Log.d(TAG, uri.toString());
		}
		else if (requestCode == SettingsSecurity.REQUEST_CODE_PUB_KEY) {
			
		}
		else if (requestCode == SettingsSecurity.REQUEST_CODE_CA) {

		}
		else{
			Log.e(SettingsSecurity.TAG, String.format("%d is an unknown request code", requestCode));
		}
	}
