...
public class SettingsNetwork extends BaseScreen {
	private final static String TAG = SettingsNetwork.class.getCanonicalName();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtRealm = (EditText)findViewById(R.id.screen_network_editText_realm);
        ...
        mCbEthernet = (CheckBox)findViewById(R.id.screen_network_checkBox_ethernet);
        ...
        mCbEthernet.setChecked(mConfigurationService.getBoolean(NgnConfigurationEntry.NETWORK_USE_ETHERNET, NgnConfigurationEntry.DEFAULT_NETWORK_USE_ETHERNET));
        ...
        super.addConfigurationListener(mCbEthernet);
	...
	protected void onPause() {
		if(super.mComputeConfiguration){
			...
			mConfigurationService.putString(NgnConfigurationEntry.NETWORK_TRANSPORT, 
					SettingsNetwork.sSpinnerTransportItems[mSpTransport.getSelectedItemPosition()]);
			mConfigurationService.putString(NgnConfigurationEntry.NETWORK_PCSCF_DISCOVERY, 
					SettingsNetwork.sSpinnerProxydiscoveryItems[mSpProxyDiscovery.getSelectedItemPosition()]);
			...
			mConfigurationService.putBoolean(NgnConfigurationEntry.NETWORK_USE_3G, 
					mCb3G.isChecked());
			mConfigurationService.putBoolean(NgnConfigurationEntry.NETWORK_USE_ETHERNET, 
					mCbEthernet.isChecked());
