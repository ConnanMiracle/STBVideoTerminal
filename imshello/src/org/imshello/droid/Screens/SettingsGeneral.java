...
public class SettingsGeneral  extends BaseScreen {
	private final static String TAG = SettingsGeneral.class.getCanonicalName();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<AudioPlayBackLevel> adapter = new ArrayAdapter<AudioPlayBackLevel>(this, android.R.layout.simple_spinner_item, SettingsGeneral.sAudioPlaybackLevels);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpAudioPlaybackLevel.setAdapter(adapter);
        // Media Profile
        ArrayAdapter<Profile> adapterProfile = new ArrayAdapter<Profile>(this, android.R.layout.simple_spinner_item, SettingsGeneral.sProfiles);
