...
public class SettingsContacts  extends BaseScreen {
	private static String TAG = SettingsContacts.class.getCanonicalName();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.settings_contacts_storage);
