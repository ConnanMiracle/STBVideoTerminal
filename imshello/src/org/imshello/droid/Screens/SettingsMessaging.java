...
public class SettingsMessaging  extends BaseScreen {
	private final static String TAG = SettingsMessaging.class.getCanonicalName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.settings_messaging);
