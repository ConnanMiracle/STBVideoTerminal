...
import org.imshello.droid.Services.Impl.ScreenService;
import org.imshello.ngn.NgnApplication;
import org.imshello.ngn.NgnEngine;
import org.imshello.ngn.NgnNativeService;
...
public class Engine extends NgnEngine{
	...
	private static final String CONTENT_TITLE = "IMSHello";
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        Intent intent = new Intent(NgnApplication.getContext(), Main.class);
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(NgnApplication.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(NgnApplication.getContext(), CONTENT_TITLE, tickerText, contentIntent);
