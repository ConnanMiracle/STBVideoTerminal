...
public class CustomDialog {
	public static AlertDialog showUpdatePrompt;
	...
	public static AlertDialog getUpdateDialog(Context context, int icon, String title, String msg, String positiveText, DialogInterface.OnClickListener positive, String negativeText, DialogInterface.OnClickListener negative){
		if (showUpdatePrompt==null) {
			try {   
				AlertDialog.Builder builder;
				...
				showUpdatePrompt=builder.create();
            } catch (Exception e) {   
                e.printStackTrace();   
            }  
